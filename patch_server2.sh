...
# Replace lines 307-349 with replacement2.js
head -n 306 server.js > new_server2.js
cat replacement2.js >> new_server2.js
tail -n +350 server.js >> new_server2.js
mv new_server2.js server.js
